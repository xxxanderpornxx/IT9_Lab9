<!-- filepath: c:\Users\hmmth\Desktop\laravel projects\Lab9\resources\views\homepage.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container mt-5">
        ...
        <!-- Form -->
        <form action="{{ route('form.submit') }}" method="POST" class="p-4 border rounded bg-light">
            @csrf
            <div class="mb-3">
